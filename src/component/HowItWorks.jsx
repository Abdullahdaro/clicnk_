    ...
    <div className='justify-center bg-bg1 xs:hidden sm:flex'>
        <div className={` xl:max-w-[1280px] w-full pt-10 pb-6`}>
            <div class="text-main items-center flex justify-center lg:text-[55px] leading-normal pb-10">
                <h1 className='bg-[#DDAC68] px-20 rounded-[40px] font-semibold bg-opacity-10'>{howitworksContent[activeLang].title}</h1>
            </div>
            <div className='flex justify-between px-10 pt-4'>
                <div className='pl-10'>
                    <div>
                        <h1 className='text-[#3C3C3B] pt-8 xs:text-sm md:text-[22px] font-semibold'>{howitworksContent[activeLang].first}</h1>
                    </div>
                ...
                <div className='pl-20'>
                    <div className='pt-5'>
                        <h1 className='text-[#3C3C3B] xs:text-sm sm:text-md md:text-[22px] flex flex-warp w-[400px] font-semibold'>{howitworksContent[activeLang].third}</h1>
                    </div>
                    <div className='flex relative pt-4'>
                ...
                <div className='pr-20 '>
                    <div>
                        <h1 className='text-[#3C3C3B] xs:text-sm sm:text-md md:text-[22px] font-semibold'>{howitworksContent[activeLang].fifth}</h1>
                    </div>
                    <div className='flex relative pt-4'>
            ...
            <div className='flex justify-between pl-32 pt-10'>
                <div>
                    ...
                    <div>
                        <h1 className='text-[#3C3C3B] pt-4 sm:text-md md:text-[22px] w-[300px] font-semibold'>{howitworksContent[activeLang].second}</h1>
                    </div>
                </div>
                <div>
                <div className='flex relative'>
                    ...
                    <div className=''>
                        <h1 className='text-[#3C3C3B] pt-4 sm:text-md md:text-[22px] flex flex-warp  w-[300px] font-semibold'>{howitworksContent[activeLang].fouth}</h1>
                    </div>
                </div>
                <div>
                <div className='flex relative'>
                    ...
                    <div>
                        <h1 className='text-[#3C3C3B] pt-4 sm:text-md md:text-[22px] w-[300px] font-semibold'>{howitworksContent[activeLang].sixth}</h1>
                    </div>
                </div>
            </div>
        </div>
