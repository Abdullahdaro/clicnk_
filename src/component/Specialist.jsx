...
const Specialist = () => {
  return (
    ...
    <div className={` xl:max-w-[1280px] w-full pt-10 relative`}>
        ...
        <div className='flex justify-between xs:px-6 md:px-10'>
            <div className='md:pl-10 flex flex-col items-center justify-start'>
                <div className='flex xs:pt-0 md:pt-4'>
                    <span className='text-[#3C3C3B] sm:text-md font-semibold  bg-opacity-10 rounded-xl'><img src={iconshine} className=' md:w-[85px] xs:w-[40px]' /></span>
                </div>
                <div>
        ...
        <div className='flex justify-between xs:px-6 md:px-10 relative md:pt-20 xs:pt-16 sm:pt-40'>
            <div className='md:pl-10 flex flex-col items-center justify-start'>
                <div className='flex xs:pt-0 md:pt-4'>
