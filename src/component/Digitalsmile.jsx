  ...
  return (
    <div className='flex justify-center'>
        <div className={` ${styles.boxWidth} justify-center relative`}>
          ...
          <div className='xs:flex xs:pb-2 sm:pb-0 justify-between xs:pl-8 sm:px-20 xs:pt-14 sm:pt-32'>
          ...
          <div className='flex relative py-2 items-center'>
              <div className="relative">
                  ...
                  <img src={machine} className='md::w-[700px] xs:w-[250px]   z-10 relative' style={{ zIndex: 10 }} />
              </div>
            </div>  
          </div>
